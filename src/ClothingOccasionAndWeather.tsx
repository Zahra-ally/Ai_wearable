...
const ClothingOccasionAndWeather: React.FC<ClothingOccasionAndWeatherProps> = ({
  weather,
}) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      axios
        .get("http://localhost:5000/message") // Make a GET request to your Flask API
        .then((response) => {
  ...
  return (
    <div>
      <div>
        <h2>Predict Clothing Type's Occasion</h2>Clothing Types:
        <br /> Jeans, T-shirt, Sweatshirt, Shorts, Skirt, Casual Dress, Hoodie,
        Cardigan, Denim Jacket, Suit , Blouse, Evening Gown, Tuxedo, Evening
        Jacket, Ballroom Dress, Trousers, Sports Jacket, Hiking Pants,
        Moisture-Wicking T-shirt, Convertible Hiking Pants, Rain Jacket
      </div>
      <br />
      <input
        type="text"
